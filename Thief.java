...
//
        ...
        body = new FilledOval (aLocation.getX()-width/2 -1, aLocation.getY()-height/2 -1, width+1, height+1, canvas);
        base = new FilledRect (aLocation.getX()-width/2 -1, aLocation.getY()-height/2 -1, width+1, height+1, canvas);
